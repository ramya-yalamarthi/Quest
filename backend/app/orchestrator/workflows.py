...
WORKFLOW_SUGGESTIONS = (
    ...
    # ── D365 Finance workflows ────────────────────────────────────────────────
    (("vendor invoice", "accounts payable", "ap invoice", "invoice posting", "fiscal period",
      "invoice pending", "invoice stuck", "posting profile", "voucher"), {
    ...
    (("general ledger", "journal", "unbalanced", "voucher", "ledger journal",
      "trial balance", "period close", "gl journal", "debit credit"), {
    ...
    (("accounts receivable", "customer invoice", "ar invoice", "customer payment",
      "settlement", "aging", "overdue", "collection"), {
    ...
    (("fixed asset", "depreciation", "asset book", "asset register",
      "acquisition", "net book value", "fa module"), {
    ...
    (("inventory", "on-hand", "on hand", "negative inventory", "warehouse",
      "stock", "item quantity", "cycle count", "inventory adjustment"), {
    ...
    (("batch job", "batch error", "batch failed", "batch stuck", "recurring job",
      "dmf", "data entity", "import", "staging", "integration"), {
